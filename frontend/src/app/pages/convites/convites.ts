...
@Component({
  ...
  imports: [CommonModule, ListaConvitesComponent, FormsModule], // Módulos e pipes necessários
...
ngOnInit(): void {
  ...
  onCreateNewInvite(): void {
    ...
    // Aqui você pode adicionar lógica para abrir um modal ou navegar para uma tela de criação de convite
  }


  onViewDetails(invitation: Invitation): void {
    alert(`Visualizar detalhes do convite: ${invitation.email}`);
    // Aqui você pode adicionar lógica para abrir um modal de detalhes ou navegar para uma tela de detalhes
  }
}
